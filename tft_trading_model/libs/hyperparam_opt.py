...
class HyperparamOptManager:
    ...
    def get_next_parameters(self, ranges_to_skip=None):
        ...
        def _get_next():
            ...
            parameters = {
                k: np.random.choice(self.param_ranges[k])
    ...
    def update_score(self, parameters, loss, model, info=""):
        ...
        self.results.to_csv(os.path.join(self.hyperparam_folder,
                                         "results.csv"))
        self.saved_params.to_csv(
            os.path.join(self.hyperparam_folder, "params.csv"))
